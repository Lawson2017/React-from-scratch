...
_reactDom.default.render(element, document.getElementById('root')); //document.body is bad practice (per the error message wisdome lol) better to access from .html file instead directly through parent elements.
